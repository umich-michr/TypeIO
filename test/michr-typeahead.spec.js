describe('MICHR Typeahead Tests', function() {
    ...
    it('Test useDefaultMatcher with valid initial result - not single value', function() {
        ...
        expect($(options.resultsContainer).html()).toContain('<select aria-hidden="true" class="hide" multiple="" data-tt-texttypeahead="" id="selectTypeaheadFormResults" name="name">');
